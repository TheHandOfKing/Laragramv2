<template>
  <div class="flex items-center justify-center w-full flex-col">
    <div v-html="messageSvg" class="svg"></div>
    <span>Your Messages</span>
    <small>Send private photos and messages to a friend or group</small>
    <button
      @click="activateChattingModal"
      class="bg-blue-500 hover:bg-blue-700 text-white text-sm font-bold py-1 px-2 rounded mt-4"
    >
      Send Message
    </button>
  </div>
