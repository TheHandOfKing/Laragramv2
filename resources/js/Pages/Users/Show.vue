<template>
    ...
    <div class="profile-description">
      ...
      <div class="info">
        ...
        <div class="sections mt-6">
          <div class="posts">
            <span class="font-bold">{{ pageData.postsCount }}</span> Posts
          </div>
          <div class="posts">
            <span class="font-bold">{{ pageData.followersCount }}</span>
            followers
          </div>
          <div class="posts">
            <span class="font-bold">{{ pageData.followCount }}</span> following
          </div>
        </div>
  ...
  <div class="modals">
    <settings-modal v-if="isActive" @close-modal="closeModal"></settings-modal>
  </div>
</template>
